      ...
      <div className="mx-auto max-w-4xl px-4 py-32 sm:py-48 lg:py-56 relative z-10">
        <div className="text-center flex flex-col items-center">
          ...
          <p className="mt-6 text-lg leading-8 text-gray-300 drop-shadow">
            Ocean Wealth Ceylon bringing you the finest and freshest aquatic products meticulously sourced from the cristal clear blue ocean of Sri Lanka. Experience unmatched quality for your culinary endeavors.
          </p>
